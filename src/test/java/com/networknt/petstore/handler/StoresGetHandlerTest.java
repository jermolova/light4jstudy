...
public class StoresGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(StoresGetHandlerTest.class);
    ...
    @Test
    public void testStoresGetHandlerTest() throws ClientException {
        final CountDownLatch latch = new CountDownLatch(1);
        SimpleConnectionHolder.ConnectionToken connectionToken = null;
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/v1/stores?limit=40";
